...
export const generalDictionary: Word[] = [
  ...
  { source: 'abbr:trick', target: '錦' },
  { source: 'abbr:equip', target: '裝' },

  { source: 'red', target: '紅色' },
...
export const eventDictionary: Word[] = [
  ...
  { source: 'downloading file {0}/{1}', target: '下載檔案 {0}/{1}' },
...
export const UiDictionary: Word[] = [
  ...
  { source: 'reverse select', target: '反選' },
  { source: 'select tips', target: '提示' },
  {
  ...
  { source: 'quickChat:0', target: '能不能快點啊，兵貴神速啊！' },
  { source: 'quickChat:1', target: '主公別開槍，自己人。' },
  { source: 'quickChat:2', target: '小內再不跳，後面還怎麼玩啊？' },
  { source: 'quickChat:3', target: '你們忍心就這麼讓我醬油了？' },
  { source: 'quickChat:4', target: '我……我惹你們了嗎？' },
  { source: 'quickChat:5', target: '姑娘，你真是條漢子。' },
  { source: 'quickChat:6', target: '三十六計走為上，容我去去便回。' },
  { source: 'quickChat:7', target: '人心散了，隊伍不好帶了啊。' },
  { source: 'quickChat:7', target: '人心散了，隊伍不好帶啊。' },
  { source: 'quickChat:8', target: '昏君！昏君啊！' },
  { source: 'quickChat:9', target: '風吹雞蛋殼，牌去人安樂。' },
  { source: 'quickChat:10', target: '小內啊，您老悠著點。' },
  { source: 'quickChat:11', target: '呃，不好意思，剛才卡了。' },
  { source: 'quickChat:12', target: '你可以打得再爛一點嗎。' },
  { source: 'quickChat:13', target: '哥們，給力點行嗎。' },
  { source: 'quickChat:14', target: '哥哥，交個朋友吧。' },
  { source: 'quickChat:15', target: '妹子，交個朋友吧。' },
  { source: 'quickChat:16', target: '我從未見過如此厚顏無恥之人！' },
  { source: 'quickChat:17', target: '這波不虧。' },
  { source: 'quickChat:18', target: '請收下我的膝蓋。' },
  { source: 'quickChat:19', target: '你咋不上天呢！' },
  { source: 'quickChat:20', target: '放開我的隊友！衝我來。' },
  { source: 'quickChat:21', target: '你隨便殺，閃不了算我輸。' },
  { source: 'quickChat:22', target: '見證奇蹟的時刻到了。' },
];
