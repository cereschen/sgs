...
export const eventDictionary: Word[] = [
  ...
  { source: '{0} displayed {1} cards to {2}', target: '{0} 对 {2} 展示了 {1}' },
  { source: 'cards displayed to you', target: '对你展示的牌' },
  { source: '{0} display handcards to you', target: '{0} 对你展示了手牌' },
...
export const UiDictionary: Word[] = [
  ...
  { source: 'reverse select', target: '反选' },
  ...
  { source: 'related skill', target: '衍生技' },
  { source: 'related skill (click to hide)', target: '衍生技（点击隐藏）' },
  { source: 'related skill (click to show)', target: '衍生技（点击显示）' },
